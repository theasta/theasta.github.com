...
function Hilitor(id, tag)
{
  ...
  this.apply = function(input)
  {
	...
	function doSearch() {
		...
		if (matchedSlides.length && (matchedSlides.length <= currentmatchedindex))="" {="" currentmatchedindex="0;" }="" if="" (matchedslides.length=""> currentMatchedIndex) {
